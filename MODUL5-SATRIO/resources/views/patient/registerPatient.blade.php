...
<body>
    ...
    <div class="container">
        <div class="form-input" style="margin-top:100px">
            ...
            <form action="/patient/vaccine/{{ $vaksin->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <h2 class="text-center">Register {{ $vaksin->name }} Patient</h2>
                
                <div class="mt-5 mb-3">
                    <label for="id" class="form-label">Vaccine ID</label>
                    <input type="text" value="{{ $vaksin->id }}" name="vaccine_id" class="form-control" id="id" readonly>
                </div>
                ...
                <div class=" mb-3">
                    ...
                    <input type="number" name="nik" class="form-control" id="id" >
                </div>
                
                <div class="mb-3">
                    <label for="id" class="form-label">alamat</label>
                    <input type="text" name="alamat" class="form-control" id="id" >
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="no_hp" class="form-control" id="id" >
                </div>

...
<body>
    ...
    <div class="container">
        <div class="form-input" style="margin-top:100px">
            <form action="/vaccine/input" method="post" enctype="multipart/form-data">
                @csrf
                <h2 class="text-center">Input Vaccine</h2>
                <div class="mt-5 mb-3">
                ...
                <input type="text" name="price" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                </div>
